...
<template>
  <section id="why" class="why-section" aria-labelledby="why-title">
    <div class="why-copy">
      ...
      <h2 id="why-title">Why I do<br>what I do.</h2>
...
.why-label{font-size:10px;letter-spacing:.3em;text-transform:uppercase;color:#17191e;margin:0 0 34px;font-weight:600;white-space:nowrap}
.why-label span{margin:0 9px}
.why-copy h2{font-family:'Playfair Display',Georgia,serif;font-weight:500;font-size:clamp(48px,6.5vw,94px);line-height:1;letter-spacing:-.065em;margin:0 0 26px;white-space:nowrap}
.why-copy>p:not(.why-label){font-size:clamp(13px,1.3vw,18px);line-height:1.55;color:#454453;letter-spacing:-.018em;margin:0;max-width:410px}
.why-copy :deep(.why-doodle){width:68%;max-width:250px;margin:12px auto 0}
.magazine-side{min-width:0;outline-offset:6px}
...
.dots button.active span{background:#111;transform:scale(1.1)}
